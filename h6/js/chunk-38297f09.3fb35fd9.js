  ...
  ["chunk-38297f09"], {
    ...
    "5b16": function(e, A, t) {
      ...
      var a = function() {
        ...
        m = {
          ...
          methods: {
            save() {
              this.m.m1 && this.m.m2 && this.m.m3 && this.m.m4 && this.m.m5 && this.m.m6 && this.m.m7 && this.m
                .m8 && this.m.m9 ? this.showTip = !0 : Object(o["a"])("数据未填写完整，请填写完整后再提交")
            },
            putGame() {
              if (this.name) {
                let e = {
                  name: this.name,
                  list: ["", this.m.m1, this.m.m2, this.m.m3, this.m.m4, this.m.m5, this.m.m6, this.m.m7, this.m
                    .m8, this.m.m9
                  ]
                };
                if (localStorage.getItem("roseList")) {
                  let A = JSON.parse(localStorage.getItem("roseList"));
                  A.push(e), console.log("obj2", A), localStorage.setItem("roseList", JSON.stringify(A))
                } else localStorage.setItem("roseList", JSON.stringify([e]));
        ...
        i = m,
        n = (t("bcc5"), t("2877")),
        c = Object(n["a"])(i, a, s, !1, null, "73ef1162", null);
      A["default"] = c.exports
    },
    "9efc": function(e, A, t) {},
    bcc5: function(e, A, t) {
    ...
    cc18: function(e, A, t) {
      ...
      var a = function() {
          ...
          }), A("span", [e._v(e._s(e.title))]), A("img", {
            directives: [{
              name: "show",
              rawName: "v-show",
              value: e.showNewGame,
        ...
        l = o,
        m = (t("d297"), t("2877")),
        i = Object(m["a"])(l, a, s, !1, null, "7ed464c4", null);
      A["a"] = i.exports
    },
    d297: function(e, A, t) {
      "use strict";
