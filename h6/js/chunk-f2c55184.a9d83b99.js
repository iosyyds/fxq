  ...
  ["chunk-f2c55184"], {
    ...
    fadc: function(t, s, e) {
      ...
      var A = function() {
          ...
          methods: {
            ...
            turn() {
              let t = document.getElementById("cube1"),
                ...
                e = 0,
                A = 0;
              if (e = Math.floor(6 * Math.random()) + 1, A = Math.floor(6 * Math.random()) + 1, e == this.one ||
                A == this.two) return console.log("let", e, A), console.log("this", this.one, this.two), void this
                .turn();
        ...
        o = c,
        l = (e("586b"), e("2877")),
        n = Object(l["a"])(o, A, a, !1, null, "3d374885", null);
      s["default"] = n.exports
    }
  }
]);