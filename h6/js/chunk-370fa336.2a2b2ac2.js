(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["chunk-370fa336"], {
    ...
    "21e5": function(s, t, e) {
      s.exports = e.p + "img/pinkRose.87b4b2e2.gif"
    },
    "39b7": function(s, t, e) {},
    "46d6": function(s, t, e) {
      "use strict";
    ...
    c058: function(s, t, e) {
      ...
      var o = function() {
          ...
          }, [s._v("请选择您的情趣玫瑰")]), t("div", {
            staticClass: "roseBox"
          }, [t("div", {
            staticClass: "roseChild"
          }, [t("img", {
            staticClass: "roseImg",
            attrs: {
              src: e("f57c"),
        ...
        A = {
          ...
          data() {
            return {
              ...
              one: 0,
              two: 0,
              list1: ["在她身体的不同部位(腹部、耳朵、嘴唇，等等)轻轻吹气", "扣含冰水伺候对方直到他/她受不了为止", "用绳子把对方绑起来尽情调戏", "指定身体某个部位让对方舔20秒",
                "互相拥抱热吻30秒", "躺下让对方服侍你一分钟", "被对方捆起来任意处置3分钟", "带上眼罩（或熊罩）被任意玩弄", "撅起PP让对方拿数据线抽打3下",
                "用扣红在对方熊部上写下邪恶的文字", "轻轻用舌头在对方背部画圈", "男生给女生转账13.14（获取七夕主动权）", "女生给男生转账13.14（获取七夕主动权）",
                "男生深情对女生告白(成功后可策马崩腾）", "女生深情对男生告白(成功后可策马崩腾）", "互相激吻抚摸一分钟（扛不住诱惑的负责解决需求）",
                "女生教导男生怎样才能让自己最舒服（男生必须认真聆听）", "男生教导女生怎样才能让自己最舒服（女生必须认真聆听）", "隔着衣服给对方熊部做5分钟情趣按摩",
                "跪舔对方30秒（可指定任意部位）", "脱光衣服（禁止抚摸）", "打开美团购买一件情趣用品（男生付款）", "躺在床上任由对方抚摸15秒", "拍一段跟对方亲热的视频（游戏结束后删除）",
                "用熊或JJ蹭对方脸部15秒", "脱光衣服（穿上情趣内衣）", "用牙齿咬住对方敏感部位磨蹭10秒", "用妩媚的表情吸吮对方手指10秒", "女生给男生来一次情趣按摩（对方有反应即止）",
                "男生给女生来一次情趣按摩（对方有反应即止）", "选择一件礼物让对方送给你（价值200以内）", "想办法一分钟内把对方弄硬/湿", "从额头一直往下舔直到脚趾结束",
                "让对方撅起PP,用力拍5下（必须用力）", "女生尽情调戏男生（男生什么都不能做）", "躺下享受被对方舔遍全身一分钟", "把手慢慢滑进对方的内裤里（轻轻的爱抚他/她）",
                "蒙住对方的双眼,将他/她推到床上激情地吸吮", "抚摸对方的屁股,并用指尖自由游走", "慢慢地抚摸对方的大腿内侧（直到对方起反应为止）", "假扮成医生给女生看病打针（用你的独有针头）",
                "女生将熊部对着男生的背部摩擦", "激情地亲吻女生的耳后（直到女生叫停）", "女生假扮按摩师给男生按摩", "用手轻轻的挑逗女生的樱桃小点（直到变硬）", "从背后慢慢地进入女生的身体",
                "将女生抱起并亲吻她1分钟（坚持不到一分钟接受女生任意惩罚）", "用低温蜡在女生身上滴3下", "女生躺下闭上眼睛,男生爱抚她的身体用你的扣水覆盖她的全身",
                "女生坐下,男生面对女生,把头放在女生的大腿内侧摩擦", "男生隔着内裤舔女生10下,让她感受到你的欲火"
              ]
            }
          },
          computed: {},
          ...
          created() {},
          mounted() {
            if (1 == this.$route.params.type) this.titleName = "情趣玫瑰-初级玫瑰", this.diceList = this.list1;
            else if (2 == this.$route.params.type);
            else if (-1 != this.$route.params.type.indexOf("auto")) {
              let s = JSON.parse(localStorage.getItem("diceList")),
                t = this.$route.params.type.split("-")[1];
              this.titleName = s[t].name, this.diceList = s[t].list
            }
            let s = document.querySelectorAll(".roseImg");
            s.forEach(s => {
              s.classList.add("roseImgRotate")
            })
          },
          methods: {
            hideBox() {
              this.gobtn = !0;
              let s = document.getElementById("roseTipBox"),
                t = document.getElementById("roseTip");
              this.showText = !1, s.classList.remove("animationRoseBox1"), t.classList.remove(
                "animationRoseBox1"), s.classList.remove("animationRoseBox2"), t.classList.remove(
                  "animationRoseBox2"), s.classList.remove("animationRoseBox3"), t.classList.remove(
                  "animationRoseBox3"), s.classList.remove("animationRoseBox4"), t.classList.remove(
                  "animationRoseBox4"), s.classList.remove("animationRoseBox5"), t.classList.remove(
                  "animationRoseBox5"), s.classList.remove("animationRoseBox6"), t.classList.remove(
                  "animationRoseBox6"), s.classList.remove("animationRoseBox7"), t.classList.remove(
                  "animationRoseBox7"), s.classList.remove("animationRoseBox8"), t.classList.remove(
                  "animationRoseBox8"), s.classList.remove("animationRoseBox9"), t.classList.remove(
                  "animationRoseBox9");
              let e = document.querySelectorAll(".roseImg");
              e.forEach(s => {
                s.classList.add("roseImgRotate")
              })
            },
            showRoseBox(s) {
              ...
              this.gobtn = !1;
              let t = document.querySelectorAll(".roseImg"),
                e = document.getElementById("roseTipBox"),
                o = document.getElementById("roseTip");
              t.forEach(s => {
                s.classList.remove("roseImgRotate")
              }), t[s].classList.add("roseImgWidth"), setTimeout(() => {
                let a = this.diceList.length - 1;
                switch (this.text = this.diceList[Math.floor(Math.random() * a)], s) {
                  case 0:
                    e.classList.add("animationRoseBox1"), o.classList.add("animationRoseBox1");
                    break;
                  case 1:
                    e.classList.add("animationRoseBox2"), o.classList.add("animationRoseBox2");
                    break;
                  case 2:
                    e.classList.add("animationRoseBox3"), o.classList.add("animationRoseBox3");
                    break;
                  case 3:
                    e.classList.add("animationRoseBox4"), o.classList.add("animationRoseBox4");
                    break;
                  case 4:
                    e.classList.add("animationRoseBox5"), o.classList.add("animationRoseBox5");
                    break;
                  case 5:
                    e.classList.add("animationRoseBox6"), o.classList.add("animationRoseBox6");
                    break;
                  case 6:
                    e.classList.add("animationRoseBox7"), o.classList.add("animationRoseBox7");
                    break;
                  case 7:
                    e.classList.add("animationRoseBox8"), o.classList.add("animationRoseBox8");
                    break;
                  case 8:
                    e.classList.add("animationRoseBox9"), o.classList.add("animationRoseBox9");
                    break;
                  default:
                    break
                }
                this.showText = !0, t[s].classList.remove("roseImgWidth")
              }, 2e3)
            },
            turnHome() {
              this.$router.push({
        ...
        c = A,
        n = (e("46d6"), e("2877")),
        r = Object(n["a"])(c, o, a, !1, null, "f4ce3cec", null);
      t["default"] = r.exports
    },
    cc18: function(s, t, e) {
      "use strict";
      var o = function() {
        ...
        A = i,
        c = (e("d297"), e("2877")),
        n = Object(c["a"])(A, o, a, !1, null, "7ed464c4", null);
      t["a"] = n.exports
    },
    d297: function(s, t, e) {
      "use strict";
    ...
    f57c: function(s, t, e) {
      s.exports = e.p + "img/roseSSS.32eb5f8d.png"
    }
  }
]);